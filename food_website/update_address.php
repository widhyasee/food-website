...
<body>
   ...
   <section class="form-container">
      ...
      <form action="" method="post">
         ...
         <input type="text" class="box" placeholder="Nama Kecamatan" required maxlength="50" name="state">
         <input type="text" class="box" placeholder="Nama Jalan" required maxlength="50" name="country">
